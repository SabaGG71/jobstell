...
export default function Hero() {
  return (
    <section className="relative h-[80vh] w-full">
      <DotBackgroundDemo />
      <div className="flex justify-center items-center pt-[197px] flex-col z-30 relative">
        ...
        <p className="text-center text-[18px] xl:text-[19px] mt-[35px] xl:mt-[60px] font-[400] max-md:px-4 text-secondary-500">
          Perfect your{" "}
        ...
        <div className="text-center flex flex-col md:flex-row justify-center items-center max-md:mt-[43px] gap-3 mt-7">
          <Link href="/dashboard">
            <button className="flex max-md:py-2 py-3 hover:translate-y-[-2px] duration-300 transition-all items-center gap-2 bg-gradient-to-b from-primary-400 to-primary-500 box-shadow text-white px-[22px] rounded-full font-[400] max-md:text-[17px] text-lg xl:ml-2">
              Get Started
