...
export default function Faq() {
  ...
  return (
    <section className="overflow-hidden max-md:mt-[150px] relative max-sm:mb-[120px] mb-[170px]">
      ...
      <h3 className="text-center max-sm:mb-9 mx-auto leading-[1.4] text-2xl sm:text-[34px] font-[400] text-secondary-900 mb-7 sm:mb-[65px]">
        Need Help?{" "}
